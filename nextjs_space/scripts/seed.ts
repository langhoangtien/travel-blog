...
async function main() {
  ...
  const author1 = await prisma.user.upsert({
    ...
    create: {
      ...
      role: "AUTHOR",
      slug: "max-mueller",
      bio: "Reiseblogger und Fotograf. Leidenschaftlich unterwegs in Europa und Asien.",
    },
  });
  ...
  const author2 = await prisma.user.upsert({
    ...
    create: {
      ...
      role: "AUTHOR",
      slug: "anna-schmidt",
      bio: "Abenteuerlust und Fernweh \u2013 Geschichten vom Reisen und Entdecken.",
    },
  });
  ...
  const cat1 = await prisma.category.upsert({
    ...
    create: {
      name: "St\u00E4dtereisen",
      slug: "staedtereisen",
      description: "Entdecken Sie die sch\u00F6nsten St\u00E4dte der Welt",
    },
  });
  ...
  const cat2 = await prisma.category.upsert({
    ...
    create: {
      name: "Strandurlaub",
      slug: "strandurlaub",
      description: "Sonne, Strand und Meer",
    },
  });
  ...
  const cat3 = await prisma.category.upsert({
    ...
    create: {
      name: "Berge & Natur",
      slug: "berge-und-natur",
      description: "Wandern, Klettern und die Natur genie\u00DFen",
    },
  });
  ...
  const cat4 = await prisma.category.upsert({
    ...
    update: {},
    create: {
      name: "Kulinarische Reisen",
      slug: "kulinarische-reisen",
      description: "Die Welt durch ihren Geschmack entdecken",
    },
  });
  ...
  const post1 = await prisma.post.upsert({
    ...
    create: {
      ...
      excerpt:
        "Barcelona ist eine Stadt voller Leben, Architektur und Kultur. Entdecken Sie die charmantesten Viertel der katalanischen Hauptstadt.",
      ...
      metaDescription:
        "Entdecken Sie die charmantesten Viertel Barcelonas: vom Gotischen Viertel \u00FCber Eixample bis Barceloneta.",
    },
  });
  ...
  const post2 = await prisma.post.upsert({
    ...
    create: {
      ...
      excerpt:
        "Wei\u00DFer Sand, t\u00FCrkisblaues Wasser und endlose Ruhe \u2013 die Malediven sind das perfekte Reiseziel f\u00FCr Erholung.",
      ...
      metaDescription:
        "Entdecken Sie die sch\u00F6nsten Str\u00E4nde der Malediven und Tipps f\u00FCr Ihren Traumurlaub.",
    },
  });
  ...
  const post3 = await prisma.post.upsert({
    ...
    create: {
      ...
      excerpt:
        "Die Schweizer Alpen bieten atemberaubende Wanderwege f\u00FCr jeden Anspruch \u2013 von gem\u00FCtlichen Spazierg\u00E4ngen bis zu anspruchsvollen Gipfeltouren.",
      ...
      metaDescription:
        "Die besten Wanderwege in den Schweizer Alpen mit praktischen Tipps f\u00FCr Ihre Tour.",
    },
  });
  ...
  const post4 = await prisma.post.upsert({
    ...
    create: {
      ...
      excerpt:
        "Bangkoks Stra\u00DFenk\u00FCchen bieten eine unglaubliche Vielfalt an Aromen und Geschm\u00E4ckern.",
      ...
      metaDescription:
        "Die besten Street-Food-M\u00E4rkte und Gerichte in Bangkok entdecken.",
    },
  });
  ...
  const postTagPairs = [
    {
      postSlug: "die-schoensten-viertel-von-barcelona",
      tagSlugs: ["europa", "kultur", "architektur"],
    },
    {
      postSlug: "traumstraende-auf-den-malediven",
      tagSlugs: ["asien", "strand", "luxusreisen", "natur"],
    },
    {
      postSlug: "wandern-in-den-schweizer-alpen",
      tagSlugs: ["europa", "wandern", "natur", "abenteuer", "fotografie"],
    },
    {
      postSlug: "street-food-in-bangkok",
      tagSlugs: ["asien", "kulinarik", "budget-reisen", "abenteuer"],
    },
  ];
